...
const portfolioData = {
  ...
  "skills": [
    ...
    {"name": "Premiere Pro", "level": 90, "icon": "🎞️"},
    {"name": "Illustrator", "level": 85, "icon": "🎨"},
    {"name": "Photoshop", "level": 88, "icon": "🖼️"},
    {"name": "Blender", "level": 75, "icon": "🏗️"},
    {"name": "Cinema 4D", "level": 70, "icon": "🎯"},
    {"name": "DaVinci Resolve", "level": 80, "icon": "🎚️"},
    {"name": "Audition", "level": 78, "icon": "🎵"}
  ],
  "social_links": [
